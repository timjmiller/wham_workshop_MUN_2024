...
#file.copy(file.path(tmp.dir, "plots_png", "diagnostics", "summary_text.png"), file.path(getwd(),"slides", "figs", "vign_3_nofit_summary.png"))
...
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_fleet_1_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_nofit_0_sel_fleet_1.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_index_1_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_nofit_0_sel_index_1.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_index_2_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_nofit_0_sel_index_2.png"))
...
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_fleet_1_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_1_sel_fleet_1.png"))
...
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_fleet_1_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_2_sel_fleet_1.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_index_1_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_2_sel_index_1.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_index_2_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_2_sel_index_2.png"))
...
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_fleet_1_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_3_sel_fleet_1.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_index_1_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_3_sel_index_1.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "Selectivity_index_2_region_1.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_3_sel_index_2.png"))
...
saveRDS(fit_9, file.path("temp", "vign_3_fit_9.RDS"))
plot_wham_output(fit_9, dir.main = tmp.dir)
# file.copy(file.path(tmp.dir, "plots_png", "results", "SelAA_tile.png"), file.path(getwd(),"slides", "figs", "vign_3_fit_9_selAA.png"))
