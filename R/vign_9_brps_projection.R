...
saveRDS(mod_1, file.path("temp", "vign_9_mod_1.RDS"))
...
saveRDS(mod_2, file.path("temp", "vign_9_mod_2.RDS"))
...
saveRDS(mod_3, file.path("temp", "vign_9_mod_3.RDS"))
...
saveRDS(mod_4, file.path("temp", "vign_9_mod_4.RDS"))
