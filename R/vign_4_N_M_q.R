...
# saveRDS(N1, file = file.path("temp", "vign_4_init_NAA.RDS"))
# saveRDS(SSB, file = file.path("temp", "vign_4_init_NAA_SSB.RDS"))
...
# saveRDS(fit_4, file.path("temp", "vign_4_fit_4.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "NAA_dev_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_4_NAA_devs.png"))
...
# saveRDS(fit_5, file.path("temp", "vign_4_fit_5.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "NAA_dev_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_5_NAA_devs.png"))
...
# saveRDS(fit_6, file.path("temp", "vign_4_fit_6.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "NAA_dev_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_6_NAA_devs.png"))
...
# saveRDS(fit_7, file.path("temp", "vign_4_fit_7.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "NAA_dev_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_7_NAA_devs.png"))
...
# saveRDS(fit_8, file.path("temp", "vign_4_fit_8.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "NAA_dev_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_8_NAA_devs.png"))
...
# saveRDS(fit_9, file.path("temp", "vign_4_fit_9.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "NAA_dev_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_9_NAA_devs.png"))
...
# saveRDS(fit_10, file.path("temp", "vign_4_fit_10.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "SSB_Rec_stock_1_fit.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_10_BH_SR.png"))
...
# saveRDS(fit_11, file.path("temp", "vign_4_fit_11.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "SSB_Rec_stock_1_fit.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_11_Ricker_SR.png"))
...
# saveRDS(fit_12, file.path("temp", "vign_4_fit_12.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "MAA_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_12_M.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "M_at_age_stock_1_.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_12_M_const.png"))
...
# saveRDS(fit_13, file.path("temp", "vign_4_fit_13.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "MAA_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_13_M.png"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "M_at_age_stock_1_.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_13_M_const.png"))
...
# saveRDS(fit_14, file.path("temp", "vign_4_fit_14.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "MAA_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_14_M.png"))
...
# saveRDS(fit_15, file.path("temp", "vign_4_fit_15.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "MAA_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_15_M.png"))
...
# saveRDS(fit_16, file.path("temp", "vign_4_fit_16.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "MAA_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_16_M.png"))
...
# saveRDS(fit_17, file.path("temp", "vign_4_fit_17.RDS"))
# plot_wham_output(fit_17, dir.main = tmp.dir)
# file.copy(file.path(tmp.dir, "plots_png", "results", "MAA_tile.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_17_M.png"))
...
# saveRDS(fit_18, file.path("temp", "vign_4_fit_18.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "q_time_series.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_18_q.png"))
...
# saveRDS(fit_19, file.path("temp", "vign_4_fit_19.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "q_time_series.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_19_q.png"))
...
# saveRDS(fit_19, file.path("temp", "vign_4_fit_20.RDS"))
# file.copy(file.path(tmp.dir, "plots_png", "results", "q_time_series.png"), file.path(getwd(),"slides", "figs", "vign_4_fit_20_q.png"))
