 ...
 * `"logistic"`: 2 parameters: $a_{50}$ and (inverse) slope
 * `"double-logistic"`: 4 parameters: increasing $a_{50}$ and slope and decreasing $a_{50}$ and slope
 * `"decreasing-logistic"`: 2 parameters decreasing $a_{50}$ and slope
...
knitr::include_graphics(here::here("slides", "figs","vign_3_nofit_summary.png"))
```
---
...
knitr::include_graphics(here::here("slides", "figs","vign_3_nofit_0_sel_fleet_1.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_nofit_0_sel_index_1.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_nofit_0_sel_index_2.png"))
```
]
...
Annual $F$ will also be estimated, so we do not expect convergence, but we can see which age the model thinks should be fully selected.
```{r, include = FALSE}
...
.pull-right[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_1_sel_fleet_1.png"))
```
]
---
...
What if we have age-specific selectivity for the fleet and the indices?
...
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_2_sel_fleet_1.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_2_sel_index_1.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_2_sel_index_2.png"))
```
]
...
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_3_sel_fleet_1.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_3_sel_index_1.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_3_sel_index_2.png"))
```
]
...
We can also freely estimate time and age varying $F$.
...
* Fix $F$ at a plausible maximum value ($F=5$), then $F_{y,a} = F * sel_{y,a}$
...
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_4_selAA.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_4_full_F.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_4_CV.png"))
```
]
...
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_5_selAA.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_5_full_F.png"))
```
]
.three-column[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_5_CV.png"))
```
]
...
.pull-right[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_6_selAA.png"))
```
]
...
.pull-right[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_7_selAA.png"))
```
]
...
.pull-right[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_8_selAA.png"))
```
]
...
knitr::include_graphics(here::here("slides", "figs","vign_3_fit_9_selAA.png"))
```
]
