...
knitr::include_graphics(here::here("slides", "figs", "vign_6_compare_sel.png"))
```
]

.pull-right[
```{r, echo = FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_compare_SSB_F_R.png"))
```
]
...
```{r, echo = FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_compare_annual_status.png"))
```
]

.pull-right[
```{r, echo = FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_compare_annual_ref_pts.png"))
```
]
...
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_jll.png"))
```
]
...
```{r, echo = FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_acomp_obs_pred.png"))
```
]
...
```{r, echo = FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_acomp_resid.png"))
```
]
...
```{r, echo = FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_acomp_osa.png"))
```
]
...
```{r, echo = FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_catch_osa_4plot.png"))
```
]
...
And for age comp:
```{r, echo = FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_acomp_osa_6plot.png"))
```
]
...
.pull-left[
```{r, echo = FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_SSB_retro.png"))
```
]

.pull-right[
```{r, echo = FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics(here::here("slides", "figs", "vign_6_fit_4_SSB_retro_rel.png"))
```
]
...
```{r, eval = FALSE}
jitter_res <- jitter_wham(fit_RDS = here::here("temp", "vign_6_fit_6.RDS"), 
...
jitter_res <- readRDS(here::here("temp", "vign_6_jitter_res.RDS"))
plot(1:10, sapply(jitter_res[[1]], function(x) x$obj) - fit_6$opt$obj, xlab = "Jitter #", ylab = "NLL Difference")
```
]
...
```{r, eval = FALSE}
self_test_res <- self_test(fit_RDS = here::here("temp", "vign_6_fit_6.RDS"), 
...
.pull-right[
```{r, echo = FALSE, out.width="90%", fig.align="center"}
self_test_res <- readRDS(here::here("temp", "vign_6_self_test_res.RDS"))
true = fit_6$rep$SSB
est = sapply(self_test_res[[1]], function(x) return(x$SSB))
SSB_rel_resid = apply(est,2, function(x) x/true - 1)
resid_cis = apply(SSB_rel_resid,1,mean) + apply(SSB_rel_resid,1,sd)*qnorm(0.975)*t(matrix(c(-1,1),2,length(true)))/sqrt(10)
