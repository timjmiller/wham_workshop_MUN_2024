...
knitr::include_graphics("figs/vign_7_fit_0_GSI_diagnostic.png")
```
]

.pull-right[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_0_GSI_osa.png")
```
]
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#NOTE: THESE PAR TABLES ARE FROM SCREENSHOTS!!!!!!!!!!!!!!!!!
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
knitr::include_graphics("figs/vign_7_fit_0_par_table.png") 
```
]
...
.pull-left[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_1_GSI_diagnostic.png")
```
]

.pull-right[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_1_GSI_osa.png")
```
]
...
knitr::include_graphics("figs/vign_7_fit_1_par_table.png")
```
]
...
knitr::include_graphics("figs/vign_7_fit_1_SR.png")
```
...
.pull-left[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_2_GSI_diagnostic.png")
```
]

.pull-right[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_2_GSI_osa.png")
```
]
...
.pull-right[
```{r, echo = FALSE, out.width="110%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_2_par_table.png")
```
]
...
.pull-left[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_3_GSI_diagnostic.png")
```
]

.pull-right[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_3_GSI_osa.png")
```
]
...
.pull-right[
```{r, echo = FALSE, out.width="110%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_3_par_table.png")
```
]
...
```{r, echo = FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_3_M.png")
```
...
```
```{r, include = FALSE}
fit_4 <- readRDS(file.path("../temp", "vign_7_fit_4_no_conv.RDS"))
```
...
.pull-right[
```{r, echo = FALSE, out.width="110%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_4_par_table.png")
```
]
...
.pull-left[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_4_SR.png")
```
]

.pull-left[
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_4_M.png")
```
]
...
```
```{r, echo = FALSE}
readRDS(file.path("../temp", "vign_7_comp_mods_1.RDS"))$tab
```
]
.pull-right[
```{r, echo = FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics("figs/vign_7_compare_SSB_F_R.png")
```
]
---
...
.pull-left[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_5_GSI_diagnostic.png")
```
]

.pull-right[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_5_GSI_osa.png")
```
]
...
.pull-right[
```{r, echo = FALSE, out.width="110%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_5_par_table.png")
```
]
...
.pull-left[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_6_GSI_diagnostic.png")
```
]

.pull-right[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_6_GSI_osa.png")
```
]
...
.pull-right[
```{r, echo = FALSE, out.width="110%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_6_par_table.png")
```
]
...
.pull-left[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_5_q.png")
```
]

.pull-right[
```{r, echo = FALSE, out.width="95%", fig.align="center"}
knitr::include_graphics("figs/vign_7_fit_6_q.png")
```
]
...
```
```{r, echo = FALSE}
readRDS(file.path("../temp", "vign_7_comp_mods_2.RDS"))$tab
```
]
.pull-right[
```{r, echo = FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics("figs/vign_7_compare_SSB_F_R_2.png")
```
]