...
```
```{r, include = FALSE}
mod_1 <- readRDS(file.path("../temp", "vign_9_mod_1.RDS"))
```
...
```
```{r, include = FALSE}
mod_2 <- readRDS(file.path("../temp", "vign_9_mod_2.RDS"))
input_2 <- mod_2$input
```
...
```
```{r, include = FALSE}
mod_3 <- readRDS(file.path("../temp", "vign_9_mod_3.RDS"))
input_3 <- mod_3$input
```
...
```
```{r, include = FALSE}
mod_4 <- readRDS(file.path("../temp", "vign_9_mod_4.RDS"))
input_4 <- mod_4$input
```
...
knitr::include_graphics("figs/vign_9_proj_1_SSB_F.png")
```
]
.pull-right[
10 years, average F (1992-1996)
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figs/vign_9_proj_10_SSB_F.png")
```
]
---
...
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figs/vign_9_proj_9_SSB_F.png")
```
]
.pull-right[
5 years, Fmsy
```{r, echo = FALSE, out.width="100%", fig.align="center"}
knitr::include_graphics("figs/vign_9_proj_11_SSB_F.png")
```
]
